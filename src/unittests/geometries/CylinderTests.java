...
class CylinderTests {
	...
	@Test
	void testGetNormal() {
		Cylinder s1 = new Cylinder(new Ray(new Point(1, 1, 1), new Vector(0, 1, 0)), 1, 5);

		// ============ Equivalence Partitions Tests ==============
		Vector e1 = s1.getNormal(new Point(1, 3, 2));
		Vector e2 = s1.getNormal(new Point(1,1,1.5));
		Vector e3 = s1.getNormal(new Point(1, 6, 1.5));
		...
		assertEquals(new Vector(0, -1, 0), e2,
				"getNormal() didn't work properly for the bottom base");

		// TC03: Test that getNormal works for the top base
		assertEquals(new Vector(0, 1, 0), e3,
				"getNormal() didn't work properly for the top base");

		// =============== Boundary Values Tests ==================
		Vector b1 = s1.getNormal(new Point(1, 1, 1));
		Vector b2 = s1.getNormal(new Point(1, 6, 1));
		...
		assertEquals(new Vector(0,1,0), b2,
				"getNormal() didn't work properly for the center point of the top base");
	}
