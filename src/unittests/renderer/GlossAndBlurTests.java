...
class GlossAndBlurTests {
	...
	public void TestCombo() {
		...
		scene.geometries.add(
				...
				new Plane(new Point(100, 0, -100), new Vector(-1, 0, 0.5))
						.setMaterial(new Material().setKd(0.3).setKr(0.8)));
		...
		ImageWriter imageWriter = new ImageWriter("TestComboWithBlur", 300, 300);
	...
	/*
	 * @Test public void geometryCombinationTest() { Camera camera = new Camera(new
	 * Point(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
	 * .setVPSize(200, 200).setVPDistance(1000);
	 * 
	 * scene.setAmbientLight(new AmbientLight(new Color(WHITE), 0.15));
	 * 
	 * scene.geometries.add( new Sphere(50d, new Point(0, 0, 0)) .setMaterial(new
	 ...
	 * .setEmission(new Color(20, 120, 50)), new Triangle(new Point(0, 20, 0), new
	 * Point(20, 70, 0), new Point(-20, 70, 0)) .setMaterial(new
	 ...
	 * 
	 * ImageWriter imageWriter = new ImageWriter("GeometryCombinationWithBlur", 300,
	 * 300); camera.setImageWriter(imageWriter) // .setRayTracer(new
