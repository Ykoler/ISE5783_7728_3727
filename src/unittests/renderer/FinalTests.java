...
//						.setMaterial(new Material().setKr(1).setKg(6)),
...
//				new Plane(new Point(0, 201, 0), new Vector(0, -1, 0))
//						.setMaterial(new Material().setKd(0.3).setKs(0.2).setShininess(9)).setEmission(new Color(150)),
//				new Plane(new Point(0, 0, -floorWidth), new Vector(0, 0, 1)).setMaterial(new Material().setKr(1)), // .setKg(5)),
//				new Plane(new Point(0, 0, floorWidth), new Vector(0, 0, -1)).setMaterial(new Material().setKt(0.8))
//						.setEmission(new Color(5)),
//
//				// CubeMan body
//				new Prism(-75, 0, -25, 50, 50, 50).setMaterial(new Material().setKd(0.7).setKs(0.6).setShininess(7))
...
//				.setKl(4E-5).setKq(2E-7));
//
//		ImageWriter imageWriter = new ImageWriter("Snowmen", 300, 300);
//		camera.setImageWriter(imageWriter) //
//				.setRayTracer(new RayTracerBasic(scene)) //
//				.renderImage() //
//				.writeToImage();
