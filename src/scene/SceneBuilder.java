...
public class SceneBuilder {
	...
	public Scene loadSceneFromFile(File xmlFile) {
        ...
        try {
            ...
            scene.setAmbientLight(new AmbientLight(ambientLightColor,Double.parseDouble(sceneDesc.ambientLightAttributes.get("k"))));
            ...
            for (Map<String, String> sphere : sceneDesc.spheres) {
                scene.geometries.add(new Sphere(
                        Double.parseDouble(sphere.get("radius")),
                        new Point(
                            Double.parseDouble(sphere.get("center").split(" ")[0]),
